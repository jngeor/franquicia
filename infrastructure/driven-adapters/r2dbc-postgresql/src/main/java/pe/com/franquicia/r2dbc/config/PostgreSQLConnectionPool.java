...
public class PostgreSQLConnectionPool {
	...
	public ConnectionPool getConnectionConfig() {
		...
		pgProperties.setDatabase(properties.getDatabase());
		pgProperties.setHost(properties.getHost());
		pgProperties.setPort(properties.getPort());
		pgProperties.setUsername(properties.getUsername());
		pgProperties.setPassword(properties.getPassword());
		pgProperties.setSchema(properties.getSchema());
